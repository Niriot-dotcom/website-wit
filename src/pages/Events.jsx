      ...
      <div className="w-full grid grid-cols-3 gap-4">
        <div class="flex justify-center">
          <div class="block rounded-lg shadow-lg bg-white max-w-sm text-center">
            ...
            <div class="p-10">
              <h5 class="text-wit-blue text-xl font-medium mb-2">
                Nombre del Evento
              </h5>
              <p class="text-gray-700 text-base mb-4">Info de eventos </p>
            </div>
        ...
        <div class="flex justify-center">
          <div class="block rounded-lg shadow-lg bg-white max-w-sm text-center">
            ...
            <div class="p-10">
              ...
              <p class="text-gray-700 text-base mb-4">Info de evento</p>
            </div>
            <div class="py-3 px-6 border-t border-purple-300 text-gray-600 text-xs">
              en 5 dias
            </div>
